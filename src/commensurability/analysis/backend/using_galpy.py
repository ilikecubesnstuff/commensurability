...
class GalpyBackend(Backend):
    ...
    def _extract_points_from_orbit(self, orbit: typing.Any, *, t: u.Quantity, phi_offset: u.Quantity):
        R = orbit.R(t)
    ...
    def _compute_orbits(self, coords: CoordinateCollection, *, t: u.Quantity, pot: typing.Any, **kwargs):
