...
from commensurability.tessellation import Tessellation, LowDimensionalityException
...
class TestInsufficientDimensionality:
    ...
    @pytest.mark.parametrize('points,exc1,exc2', [
...
class TestMeasure:
    ...
    @pytest.mark.parametrize('points,expected_measure', [
